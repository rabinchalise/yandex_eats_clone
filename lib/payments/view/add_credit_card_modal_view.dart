...
class AddCreditCardModalView extends StatefulWidget {
  const AddCreditCardModalView({super.key});

  @override
  State<AddCreditCardModalView> createState() => _AddCreditCardModalViewState();
}

class _AddCreditCardModalViewState extends State<AddCreditCardModalView> {
